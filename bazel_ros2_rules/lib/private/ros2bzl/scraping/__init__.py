...
from ros2bzl.scraping.metadata import (
    collect_cmake_package_metadata,
    collect_python_package_metadata,
    collect_ros_package_metadata,
)
...
def scrape_distribution(include=None, exclude=None):
    ...
    # Since rules_python 1.6.3 python paths aren"t automatically propagated
