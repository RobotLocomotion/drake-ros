...
bash setup_render_test.sh -d models/NAO -m model.sdf -i 0.9
...
bash setup_render_test.sh -d models/shadow_hand -m model.sdf -i 0.9
...
bash setup_render_test.sh -d models/Panda -m model.sdf -i 0.9
...
bash setup_render_test.sh -d models/CERBERUS_ANYMAL_C_SENSOR_CONFIG_2 -m model.sdf -i 0.9
...
bash setup_render_test.sh -d models/MPL -m model.sdf -i 0.9
