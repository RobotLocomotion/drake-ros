...
// TODO(Aditya):Use serialization-deserialization based generic typecasting.
...
template <>
struct type_caster<geometry_msgs::msg::Point> {
 public:
  PYBIND11_TYPE_CASTER(geometry_msgs::msg::Point, _("geometry_msgs.msg.Point"));
  ...
  static handle cast(geometry_msgs::msg::Point src, return_value_policy policy,
                     handle parent) {
    (void)policy;
    (void)parent;
...
template <>
struct type_caster<geometry_msgs::msg::Twist> {
 public:
  PYBIND11_TYPE_CASTER(geometry_msgs::msg::Twist, _("geometry_msgs.msg.Twist"));
  ...
  static handle cast(geometry_msgs::msg::Twist src, return_value_policy policy,
                     handle parent) {
    (void)policy;
    (void)parent;
...
template <>
struct type_caster<geometry_msgs::msg::Accel> {
 public:
  PYBIND11_TYPE_CASTER(geometry_msgs::msg::Accel, _("geometry_msgs.msg.Accel"));
  ...
  static handle cast(geometry_msgs::msg::Accel src, return_value_policy policy,
                     handle parent) {
    (void)policy;
    (void)parent;
...
template <>
struct type_caster<geometry_msgs::msg::Wrench> {
 public:
  ...
  static handle cast(geometry_msgs::msg::Wrench src, return_value_policy policy,
                     handle parent) {
    (void)policy;
    (void)parent;
...
template <>
struct type_caster<geometry_msgs::msg::Pose> {
 public:
  PYBIND11_TYPE_CASTER(geometry_msgs::msg::Pose, _("geometry_msgs.msg.Pose"));
  ...
  static handle cast(geometry_msgs::msg::Pose src, return_value_policy policy,
                     handle parent) {
    (void)policy;
    (void)parent;
