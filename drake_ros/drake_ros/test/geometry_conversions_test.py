...
def test_ros_quaternion_to_rotation_matrix():
    ...
    np.testing.assert_array_equal(
        rot_matrix_expected, rot_matrix_converted.matrix()
    )
...
def test_ros_pose_to_rigid_transform():
    ...
    np.testing.assert_array_equal(
        rigid_transform_converted.translation(), np.array([1.0, 2.0, 3.0])
    )

    assert np.allclose(
        rigid_transform_converted.rotation().matrix(),
        np.array(
            [
...
def test_ros_pose_to_isometry3():
    ...
    np.testing.assert_array_equal(
        isometry_converted.translation(), np.array([1.0, 2.0, 3.0])
    )
...
def test_isometry3_to_ros_pose():
    ...
    ros_pose_converted = drake_ros.core.Isometry3ToRosPose(isometry=isometry3)
...
def test_spatial_velocity_to_ros_twist():
    ...
    ros_twist_converted = drake_ros.core.SpatialVelocityToRosTwist(
        velocity=pydrake.multibody.math.SpatialVelocity_[float](
            w=np.array([11.11, 22.22, 33.33]), v=np.array([1.11, 2.22, 3.33])
        )
    )
...
def test_ros_twist_to_spatial_velocity():
    ...
    np.testing.assert_array_equal(
        np.array([1.11, 2.22, 3.33]), spatial_vel_converted.translational()
    )
    np.testing.assert_array_equal(
        np.array([11.11, 22.22, 33.33]), spatial_vel_converted.rotational()
    )
...
def test_ros_twist_to_vector6():
    ...
    np.testing.assert_array_equal(
        vec6_converted, np.array([11.11, 22.22, 33.33, 1.11, 2.22, 3.33])
    )
...
def test_ros_accel_to_spatial_acceleration():
    ...
    np.testing.assert_array_equal(
        np.array([1.11, 2.22, 3.33]), spatial_accel_converted.translational()
    )
    np.testing.assert_array_equal(
        np.array([11.11, 22.22, 33.33]), spatial_accel_converted.rotational()
    )
...
def test_ros_wrench_to_spatial_force():
    ...
    np.testing.assert_array_equal(
        np.array([1.11, 2.22, 3.33]), spatial_force_converted.translational()
    )
    np.testing.assert_array_equal(
        np.array([11.11, 22.22, 33.33]), spatial_force_converted.rotational()
    )
...
def test_spatial_force_to_ros_wrench():
    ...
    ros_wrench_converted = drake_ros.core.SpatialForceToRosWrench(
        force=pydrake.multibody.math.SpatialForce_[float](
            tau=np.array([11.11, 22.22, 33.33]), f=np.array([1.11, 2.22, 3.33])
        )
    )
    assert ros_wrench_converted == w
