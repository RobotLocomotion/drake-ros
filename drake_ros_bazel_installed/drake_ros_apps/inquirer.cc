...
public:
  Inquirer() : Node("inquirer") {
    ...
    status_sub_ =
      this->create_subscription<drake_ros_apps_msgs::msg::Status>(
        "status", rclcpp::QoS(rclcpp::KeepLast(1)),
        std::bind(&Inquirer::on_status, this, _1));

    query_client_ = this->create_client<drake_ros_common_msgs::srv::Query>("query");

    action_client_ = rclcpp_action::create_client<drake_ros_common_msgs::action::Do>(this, "do");
...
private:
  ...
  using ActionGoalHandle = rclcpp_action::ClientGoalHandle<drake_ros_common_msgs::action::Do>;
  ...
  void inquire() const {
    ...
    if (action_client_->action_server_is_ready()) {
      rclcpp_action::Client<drake_ros_common_msgs::action::Do>::SendGoalOptions options;
  ...
  std::shared_ptr<rclcpp::Subscription<drake_ros_apps_msgs::msg::Status>> status_sub_;
  std::shared_ptr<rclcpp::Client<drake_ros_common_msgs::srv::Query>> query_client_;
  std::shared_ptr<rclcpp_action::Client<drake_ros_common_msgs::action::Do>> action_client_;
