...
class Oracle : public rclcpp::Node {
 public:
  Oracle() : Node("oracle") {
    ...
    action_server_ =
        rclcpp_action::create_server<drake_ros_common_msgs::action::Do>(
 ...
 private:
  rclcpp_action::GoalResponse handle_action_goal(
      ...
      const std::shared_ptr<const drake_ros_common_msgs::action::Do::Goal>
          goal) {
    if (goal->action != "rite") {
  ...
  using GoalHandle =
      rclcpp_action::ServerGoalHandle<drake_ros_common_msgs::action::Do>;
  ...
  void handle_rite_action(const std::shared_ptr<GoalHandle> handle) {
    if (handle->is_canceling()) {
      auto result =
          std::make_shared<drake_ros_common_msgs::action::Do::Result>();
    ...
    auto feedback =
        std::make_shared<drake_ros_common_msgs::action::Do::Feedback>();
  ...
  void handle_query(
      ...
      std::shared_ptr<drake_ros_common_msgs::srv::Query::Response> response)
      const {
  ...
  std::shared_ptr<rclcpp::Publisher<drake_ros_apps_msgs::msg::Status>>
      status_pub_;
  std::shared_ptr<rclcpp::Service<drake_ros_common_msgs::srv::Query>>
      query_server_;
  std::shared_ptr<rclcpp_action::Server<drake_ros_common_msgs::action::Do>>
      action_server_;
};
