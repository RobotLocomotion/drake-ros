...
#include <drake_ros_introspection/introspector_builder.h>
...
int main() {
  ...
  drake_ros_introspection::IntrospectorBuilder<double> introspector_builder;
  introspector_builder.introspect(*diagram);

  drake_ros_introspection::Introspector<double> introspector = introspector_builder.build();
  (void) introspector;
