...
TEST(NameConventions, CalcTfFrameNameWithoutBody) {
  ...
  EXPECT_EQ("frame_name",
            drake_ros_tf2::utilities::CalcTfFrameName("frame_name", 123));

  // Frame name is empty
  EXPECT_EQ("unnamed_frame_123",
            drake_ros_tf2::utilities::CalcTfFrameName("", 123));
